...
public class Class {
	...
	public boolean addRelationship(Class destination, String typeName) {
		...
		if (relationships.isEmpty()) {
			...
			// System.out.println("Relationship added from " + className + " to " +
	...
	// Should fail if the field does not exist or the new field type is the same as
	// the field's type
	public boolean changefieldType(String fieldName, String newFieldType) {
		...
		while (fldItr.hasNext()) {
			...
			if (current.getFieldName().toUpperCase().equals(fieldName.toUpperCase())) {
				...
				System.out.println("The field " + current.getFieldName() + "'s type has been changed to "
						+ current.getFieldType() + "!");
				return true;
			}
		}
	...
	// Should fail if the field 'oldName' does not exist OR if a field 'newName'
	// already exists
	...
	// Should fail if the method 'oldName' does not exist OR if a method 'newName'
	// already exists
	...
	// Should fail if the Method does not exist or the new return type is the same
	// as the current return type
	public boolean changeMethodreturn(String methodName, String newReturnType) {
		...
		while (methItr.hasNext()) {
			...
			if (current.getMethodName().toUpperCase().equals(methodName.toUpperCase())) {
				...
				System.out.println("The method " + current.getMethodName() + "'s return type has been changed to "
